...
_lr_productions = [
  ...
  ('statement -> let_statement','statement',1,'p_statement','parser.py',19),
  ('statement -> print_statement','statement',1,'p_statement','parser.py',20),
  ('let_statement -> LET IDENTIFIER COLON TYPE EQUALS expression SEMICOLON','let_statement',7,'p_let_statement','parser.py',25),
  ('print_statement -> PRINT LPAREN expression RPAREN SEMICOLON','print_statement',5,'p_print_statement','parser.py',30),
  ('expression -> expression INT_OP expression','expression',3,'p_expression_binop','parser.py',35),
  ('expression -> expression BOOL_OP expression','expression',3,'p_expression_binop','parser.py',36),
  ('expression -> NOT expression','expression',2,'p_expression_not','parser.py',41),
  ...
  ('expression -> INT','expression',1,'p_expression_int','parser.py',56),
  ('expression -> BOOL','expression',1,'p_expression_bool','parser.py',61),
]
